...
namespace Test
{
	public class AsyncTest3 : TestServer
	{
		private ListenerService3 listener;
			
		public void Run(string url = "http://localhost:5003")
		{
			listener = new ListenerService3(new Uri(url));
	...
	class ListenerService3 : IDisposable
	{
		...
		public ListenerService3(Uri listenerPrefix)
		{
			Uri = listenerPrefix;
