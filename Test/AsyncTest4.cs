...
namespace Test
{
	public class AsyncTest4 : TestServer
	{
		private ListenerService4 listener;
			
		public void Run(string url = "http://localhost:5004")
		{
			listener = new ListenerService4(new Uri(url));
	...
	class ListenerService4 : IDisposable
	{
		...
		public ListenerService4(Uri listenerPrefix)
		{
			Uri = listenerPrefix;
